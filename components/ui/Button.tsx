...
export function Button({
  ...
  const variants = {
    ...
    danger: 'bg-gradient-to-r from-error-600 to-error-500 text-white hover:from-error-700 hover:to-error-600 focus:ring-error-500 shadow-lg shadow-error-500/30',
  };
